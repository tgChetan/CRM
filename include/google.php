...
if (isset($_GET['code'])) {
    ...
    if (empty($info[0]) || empty($info[1])) {
        die('<br><br>Please enter Client ID and Client Secret in TG CRM > Settings > Artificial Intelligence > Google.');
    }
    ...
    if ($response && isset($response['refresh_token'])) {
        die('<br><br>Copy the refresh token below and paste it in TG CRM > Settings > Artificial Intelligence > Google > Refresh token.<br><br><b>' . $response['refresh_token'] . '</b>');
    } else {
